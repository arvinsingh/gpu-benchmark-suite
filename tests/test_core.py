...
from gpu_benchmark.core.metrics import BenchmarkResult, MetricsCollector
...
class TestBenchmarkResult:
    ...
    def test_default_metadata(self):
        ...
        result_with_metadata = BenchmarkResult(
            "test", "backend", 1.0, metadata={"key": "value"}
        )
...
class TestBenchmarkRunner:
    ...
    def test_register_benchmark(self):
        ...
        runner.register_benchmark(
            category="test", name="dummy", pytorch_impl=dummy_impl
        )
    ...
    def test_prepare_benchmark_args(self):
        ...
        args, ref = runner._prepare_benchmark_args(
            "memory", "vector-add", "pytorch", 1000
        )

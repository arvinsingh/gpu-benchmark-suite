...
class DeviceInfo:
    ...
    def get_device_info(self, device_id: int = 0) -> Dict[str, any]:
        ...
        # power consumption
        try:
            info["power_draw"] = pynvml.nvmlDeviceGetPowerUsage(handle) / 1000.0  # Convert to watts
            info["power_limit"] = pynvml.nvmlDeviceGetPowerManagementLimitConstraints(handle)[1] / 1000.0
        except pynvml.NVMLError:
            pass
